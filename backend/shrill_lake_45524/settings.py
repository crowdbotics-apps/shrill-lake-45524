"""
Django settings for shrill_lake_45524 project.
...
ROOT_URLCONF = 'shrill_lake_45524.urls'
...
WSGI_APPLICATION = 'shrill_lake_45524.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shrill_lake_45524 API",
    "DESCRIPTION": "API documentation for shrill_lake_45524 App",
    "VERSION": "v1",
}
